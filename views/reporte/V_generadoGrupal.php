...
<main>
  ...
  <h1 class="text-primary text-center"><strong>Reporte grupal</strong></h1>
  ...
  <div class="container col-6 mt-4">
    ...
    <div class="mt-2">
      <div class="progress">
        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $asistenciaTotal . '%'; ?>;"></div>
      </div>
      <h5 class="text-end mt-2">Porcentaje de asistencia <?php echo $asistenciaTotal . '%'; ?></h5>
