  ...
  <div class="container">
    <div class="d-flex justify-content-center">
      ...
      <div class="col card text-white bg-primary mt-5 mb-3 me-3" style="max-width: 20rem; text-align: center;">
        ...
        <div class="card-body">
          <a href="index.php?c=reporte&a=grupal<?php echo '&tr=' . $reporte->trabajos . '&ta=' . $reporte->tareas . '&ex='. $reporte->examenes . '&fi=' . $reporte->inicio . '&ff=' . $reporte->fin ;?>" class="link-light">
