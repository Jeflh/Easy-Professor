...
<main>
  ...
  <div class="container">
    <h1 class="text-center text-primary mt-5"><strong>Terminos y condiciones de uso</strong></h1>
    <div class="d-flex justify-content-center">

      <div class="col-8" style="text-align: justify;">
        <p class="fw-bold">Información importante</p>
        ...
        <p>El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. easyprofessor.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.</p>


        <p class="fw-bold">Licencia</p>

        <p>Easy Professor a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>

        <p class="fw-bold">Uso no autorizado</p>
        ...
        <p class="fw-bold">Politica de reembolso y garantía</p>
        ...
        <p class="fw-bold">Comprobación antifraude</p>
        ...
        <p>Easy Professor reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
